...
def create(name='AsicRxReg', offset=0, memBase=None, hidden=False):
    ...
    dev.add(pyrogue.Variable(name='idelay0',
                             ...
                             hidden=False, enum=None, offset=0x00, bitSize=5, bitOffset=0, base='hex', mode='RW'))
    ...
    dev.add(pyrogue.Variable(name='idelay2',
                             ...
                             hidden=False, enum=None, offset=0x08, bitSize=5, bitOffset=0, base='hex', mode='RW'))
                             
    dev.add(pyrogue.Variable(name='idelay3',
                             description='IDDR`s idelay[3]',
                             hidden=False, enum=None, offset=0x0C, bitSize=5, bitOffset=0, base='hex', mode='RW'))    
                             
    dev.add(pyrogue.Variable(name='idelay4',
                             description='IDDR`s idelay[4]',
                             hidden=False, enum=None, offset=0x10, bitSize=5, bitOffset=0, base='hex', mode='RW'))
    ...
    dev.add(pyrogue.Variable(name='idelay8',
                             ...
                             hidden=False, enum=None, offset=0x20, bitSize=5, bitOffset=0, base='hex', mode='RW'))
                             
    dev.add(pyrogue.Variable(name='idelay9',
                             description='IDDR`s idelay[9]',
                             hidden=False, enum=None, offset=0x24, bitSize=5, bitOffset=0, base='hex', mode='RW'))                             
                             
    dev.add(pyrogue.Variable(name='idelay10',
                             description='IDDR`s idelay[10]',
                             hidden=False, enum=None, offset=0x28, bitSize=5, bitOffset=0, base='hex', mode='RW'))
                             
    dev.add(pyrogue.Variable(name='idelay11',
                             description='IDDR`s idelay[11]',
                             hidden=False, enum=None, offset=0x2C, bitSize=5, bitOffset=0, base='hex', mode='RW'))    
                             
    dev.add(pyrogue.Variable(name='idelay12',
                             description='IDDR`s idelay[12]',
                             hidden=False, enum=None, offset=0x30, bitSize=5, bitOffset=0, base='hex', mode='RW'))
                             
    dev.add(pyrogue.Variable(name='idelay13',
                             description='IDDR`s idelay[13]',
                             hidden=False, enum=None, offset=0x34, bitSize=5, bitOffset=0, base='hex', mode='RW'))                                  
